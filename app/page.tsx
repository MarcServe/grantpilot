...
const opportunities = [
  {
    ...
    detail: "Up to £25,000 · Innovation",
    score: "92%",
  },
  {
    name: "Small Business Research Initiative",
    detail: "Up to £15,000 · Research",
    score: "85%",
  },
  {
    name: "Green Growth Fund",
    detail: "Up to £50,000 · Sustainability",
    score: "78%",
  },
];
...
const featureCards = [
  {
    ...
    text: "Answer once. Reuse your business information across relevant opportunities. Keep your company facts, funding goals and evidence in one Business DNA profile.",
  },
  {
    icon: Target,
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f7fbff] text-[#071a3a]">
      <header className="mx-auto flex max-w-[1480px] items-center justify-between gap-3 px-4 py-4 sm:px-6 sm:py-6 lg:px-10">
        ...
        >
          ...
          <div className="min-w-0 leading-none">
            ...
            <div className="mt-1 hidden text-[12px] font-semibold text-[#071a3a] min-[430px]:block sm:text-[13px]">
              ...
              <span className="text-[#2fbf84]">Apply on autopilot.</span>
            </div>
          </div>
        </Link>
        ...
        {isSignedIn ? (
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/sign-in"
              className="hidden text-[15px] font-bold text-[#071a3a] sm:inline-flex"
            >
              Log in
            </Link>
            <Link
      ...
      <main>
        <section className="mx-auto flex max-w-[1480px] flex-col gap-8 px-4 pb-10 pt-6 sm:px-6 lg:flex-row lg:items-start lg:gap-10 lg:px-10 lg:pb-12 lg:pt-10">
          <div className="order-2 w-full max-w-[610px] shrink-0 lg:order-1 lg:max-w-[min(100%,610px)] lg:basis-[min(610px,44%)]">
            ...
            <p className="mt-5 max-w-[560px] text-[18px] font-medium leading-[1.55] text-[#09224a] sm:mt-6 sm:text-[20px]">
              Create your Business DNA once. GrantsCopilot AI finds relevant
              grants, scores your fit, flags missing evidence, and helps you
        ...
        <section
          id="get-started"
          className="mx-auto max-w-[1480px] px-4 py-8 sm:px-6 sm:py-10 lg:px-10"
        >
          <div className="grid items-center gap-6 rounded-[24px] bg-[linear-gradient(115deg,#e7f1ff,#ffffff)] p-6 shadow-[0_18px_50px_rgba(7,26,58,0.08)] sm:p-8 lg:grid-cols-[1fr_auto] lg:p-10">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.14em] text-[#2167e8]">
                Get started
              </p>
              ...
              <p className="mt-4 max-w-3xl text-base font-medium leading-7 text-[#51627d]">
                Create your Business DNA profile once. GrantsCopilot keeps
                scanning, scoring, reminding, and preparing applications around
                what your company actually qualifies for.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
                href={isSignedIn ? "/dashboard" : "/sign-up"}
                className="inline-flex h-12 items-center justify-center rounded-lg bg-[#2167e8] px-7 text-sm font-black text-white"
              >
              ...
              {!isSignedIn && (
                <Link
                  href="/sign-in"
                  className="inline-flex h-12 items-center justify-center rounded-lg border border-[#d8e2f2] bg-white px-7 text-sm font-black text-[#071a3a]"
                >
                  Log in
                </Link>
              )}
        ...
        <section
          id="pricing"
          className="mx-auto max-w-[1480px] px-4 py-10 sm:px-6 sm:py-12 lg:px-10"
        >
          <div className="text-center">
            <p className="text-sm font-black uppercase tracking-[0.14em] text-[#2167e8]">
              Pricing
            </p>
            <h2 className="mt-4 text-[32px] font-black leading-tight text-[#071a3a] sm:text-[40px]">
              Start with funding intelligence. Scale into automation.
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg font-medium leading-8 text-[#51627d]">
              Pick the level of funding support that matches your team. Upgrade
              when you are ready for deeper scoring, application preparation,
              and founder pack generation. Today, GrantsCopilot focuses on
              discovery, scoring, preparation, and reminders; full auto-filing
              remains a V2 workflow.
            </p>
          </div>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p
                      className={`mt-2 text-sm font-semibold ${tier.featured ? "text-white/72" : "text-[#51627d]"}`}
                    >
                      {tier.detail}
                    </p>
                  </div>
                  {tier.featured && (
                    <span className="rounded-full bg-[#35c386] px-3 py-1 text-xs font-black text-white">
                      Most useful
                    </span>
                  )}
                </div>
                ...
                <ul className="mt-7 space-y-3">
                  {tier.summaryFeatures.map((item) => (
                    <li key={item} className="flex gap-3 text-sm font-bold">
                      <CheckCircle2
                        className={`mt-0.5 h-4 w-4 shrink-0 ${tier.featured ? "text-[#35c386]" : "text-[#2167e8]"}`}
                      />
                      <span>{item}</span>
                    </li>
                  ))}
                ...
                >
                  ...
                  <div
                    className={`mt-4 space-y-4 text-left ${tier.featured ? "text-white/92" : "text-[#071a3a]"}`}
                  >
                      ...
                      <div key={block.heading}>
                        ...
                        <ul className="mt-2 space-y-2">
                          {block.bullets.map((bullet) => (
                            <li
                              key={bullet}
                              className="flex gap-2 text-xs font-bold leading-snug sm:text-sm"
                            >
                              <CheckCircle2
          ...
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              ...
              <p className="mt-5 max-w-[560px] text-lg font-medium leading-8 text-[#334766]">
                GrantsCopilot is not another grant directory. It learns what
                your business does, brings the right opportunities forward, and
                turns funding work into a structured application preparation
                pipeline.
              </p>
              ...
              {featureCards.map((feature) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-5 text-xl font-black text-[#071a3a]">
                      {feature.title}
                    </h3>
                    <p className="mt-3 text-sm font-medium leading-6 text-[#51627d]">
                      {feature.text}
                    </p>
                  </div>
                );
        ...
        <section
          id="how-it-works"
          className="mx-auto max-w-[1480px] px-4 pb-8 pt-2 sm:px-6 lg:px-10"
        >
          <div className="rounded-[18px] bg-[linear-gradient(115deg,#123577_0%,#0d3e95_52%,#2468e8_100%)] px-5 py-7 text-white shadow-[0_22px_55px_rgba(10,50,120,0.16)] sm:px-9 lg:px-10">
            ...
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_0.36fr_1fr_0.36fr_1fr_0.36fr_1.5fr]">
              <Step
                icon={Search}
                title="1. Watch"
                text="Your funding radar scans grant feeds, databases, and web sources so you do not have to keep searching."
              />
              <ArrowDivider />
              <Step
                icon={Target}
                title="2. Match"
                text="Our AI checks eligibility signals and ranks opportunities by fit, gaps, and readiness."
                accent="green"
              />
              <ArrowDivider />
              <Step
                icon={Send}
                title="3. Prepare"
                text="Generate funder-ready answers, document checklists, pitch decks, and application tasks."
                accent="purple"
              />
              <ArrowDivider />
              <div className="flex min-h-[126px] items-center gap-6 rounded-xl border border-white/22 bg-white/8 px-7 py-5">
                ...
                <div>
                  ...
                  <p className="mt-2 text-[14px] font-medium leading-6 text-white/90">
                    Review the grants that matter, prepare faster, and stop
                    losing time to stale funding pages. Full auto-filing is
                    planned for V2.
                  </p>
                </div>
              </div>
          ...
          <div className="rounded-[24px] bg-white p-5 shadow-[0_20px_60px_rgba(7,26,58,0.08)] sm:p-7 lg:p-9">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <h2 className="mt-4 text-[30px] font-black leading-tight text-[#071a3a] sm:text-[38px]">
                  Practical funding help for non-grant experts.
                </h2>
              </div>
              <Link
                href={isSignedIn ? "/dashboard" : "/sign-up"}
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[#2167e8] px-6 text-sm font-black text-white"
              >
        ...
        >
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[24px] bg-[#071a3a] p-6 text-white shadow-[0_22px_55px_rgba(7,26,58,0.16)] sm:p-8">
              <p className="text-sm font-black uppercase tracking-[0.14em] text-[#8bb6ff]">
                About Us
              </p>
              <h2 className="mt-4 text-[30px] font-black leading-tight sm:text-[38px]">
                Building the operating system for business funding.
              </h2>
              <p className="mt-5 text-base font-medium leading-8 text-white/78">
                GrantsCopilot helps founders and SMEs move from fragmented
                funding discovery to an intelligent funding pipeline: profile,
                match, draft, prepare, learn, and improve. Auto-filing sits on
                the V2 roadmap.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <AboutStat
                value="24/7"
                label="Funding discovery and monitoring"
              />
              <AboutStat
                value="AI"
                label="Eligibility reasoning and application drafting"
              />
              <AboutStat
                value="UK+"
                label="Built for UK SMEs with global expansion in mind"
              />
              <AboutStat
                value="Review"
                label="Human approval before sensitive submission steps"
              />
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-[1200px] px-4 pb-12 pt-4 text-center sm:px-6">
          <p className="text-[16px] font-semibold text-[#09224a]">
            Built for founders, SMEs, and funding teams
          </p>
          <div className="mt-7 grid grid-cols-2 items-center gap-8 text-[#071a3a] sm:grid-cols-3 lg:grid-cols-6">
            {audienceSegments.map((segment) => (
              <div
                key={segment}
                className="flex items-center justify-center gap-2 text-[18px] font-black tracking-tight"
              >
      ...
      <footer className="border-t border-[#d8e2f2] bg-white/75">
        <div className="mx-auto flex max-w-[1480px] flex-col gap-4 px-4 py-8 text-sm font-semibold text-[#51627d] sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-10">
          <p>
            © 2026 GrantsCopilot. Funding intelligence for founders and SMEs.
          </p>
          <div className="flex flex-wrap gap-4">
            <Link href="/privacy" className="hover:text-[#2167e8]">
              Privacy
            </Link>
            <Link href="/terms" className="hover:text-[#2167e8]">
              Terms
            </Link>
            <Link href="/refund" className="hover:text-[#2167e8]">
              Refund policy
            </Link>
            <Link
              href={isSignedIn ? "/dashboard" : "/sign-in"}
              className="hover:text-[#2167e8]"
            >
    ...
    <div className="relative mx-auto w-full max-w-[860px] lg:mx-0 lg:max-w-none">
      ...
      <div className="relative z-10 grid overflow-hidden rounded-[20px] bg-white shadow-[0_30px_80px_rgba(7,26,58,0.14)] lg:grid-cols-[180px_1fr]">
        ...
        <div className="@container/preview min-w-0 p-5 sm:p-7">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h2 className="text-[21px] font-black text-[#071a3a]">
                Welcome back
              </h2>
              <p className="mt-1 text-[12px] font-medium text-[#54657f]">
                ...
                >
                  <div className="flex flex-col gap-2 @[200px]/stat:flex-row @[200px]/stat:items-center @[200px]/stat:gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="text-[11px] font-semibold leading-snug text-[#65748c]">
                        {stat.label}
                      </p>
                      <p className="break-words text-xl font-black leading-none tracking-tight text-[#071a3a] @[200px]/stat:text-2xl">
                        {stat.value}
                      </p>
                      <p className="mt-1 text-[11px] font-semibold leading-snug text-[#071a3a]">
                        {stat.detail}
                      </p>
                    </div>
                  </div>
          ...
          <div className="mt-4 grid min-w-0 grid-cols-1 gap-4 @min-[460px]/preview:grid-cols-2">
            <div className="min-w-0 rounded-lg border border-[#eef2f7] bg-white p-5 shadow-[0_10px_28px_rgba(9,34,74,0.07)]">
              <div className="flex items-center justify-between">
                <h3 className="text-[15px] font-black text-[#071a3a]">
                  Top Matched Opportunities
                </h3>
                <Link
                  href="/grants/eligible"
                  className="text-[12px] font-bold text-[#2167e8]"
                >
                  View all
                </Link>
              </div>
              <div className="mt-4 divide-y divide-[#edf2f7]">
                {opportunities.map((grant) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate text-[12px] font-black text-[#071a3a]">
                        {grant.name}
                      </p>
                      <p className="mt-1 text-[10px] font-semibold text-[#54657f]">
                        {grant.detail}
                      </p>
                    </div>
              ...
              <div className="mt-5 flex flex-col items-center gap-6 @min-[260px]/aprog:flex-row @min-[260px]/aprog:justify-center @min-[260px]/aprog:gap-8">
                <div className="grid h-32 w-32 shrink-0 place-items-center rounded-full bg-[conic-gradient(#2167e8_0_42%,#35c386_42%_73%,#4bc7ad_73%_100%)]">
                  <div className="grid h-20 w-20 place-items-center rounded-full bg-white text-center shadow-inner">
                    <div>
                      <p className="text-[26px] font-black leading-none text-[#071a3a]">
                        7
                      </p>
                      <p className="mt-1 text-[11px] font-semibold text-[#54657f]">
                        In Progress
                      </p>
                    </div>
                  </div>
          ...
          <div className="mt-4 overflow-hidden rounded-lg bg-[#eaf3ff] px-8 py-5">
            <div className="flex items-center justify-between gap-5">
              <div>
                <p className="text-[17px] font-black text-[#071a3a]">
                  Stop searching. Let the right grants surface.
                </p>
                <p className="mt-2 text-[12px] font-medium text-[#2a4065]">
                  GrantsCopilot keeps watch, ranks the best fits, and prepares
                  the next step.
                </p>
              </div>
...
function Step({
  ...
  const accentClass =
    accent === "green"
      ? "text-[#35c386] shadow-[#35c386]/30"
      : accent === "purple"
        ? "text-[#8d6bf6] shadow-[#8d6bf6]/30"
        : "text-[#2167e8] shadow-[#2167e8]/30";

  return (
    <div className="grid grid-cols-[86px_1fr] items-center gap-5">
      <div
        className={`flex h-20 w-20 items-center justify-center rounded-full bg-white ${accentClass} shadow-[0_0_0_8px_var(--tw-shadow-color)]`}
      >
        <Icon className="h-9 w-9" />
      </div>
      <div>
        <h3 className="text-[22px] font-black">{title}</h3>
        <p className="mt-2 text-[14px] font-medium leading-6 text-white/92">
          {text}
        </p>
      </div>
    </div>
