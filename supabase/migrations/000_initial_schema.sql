...
CREATE TABLE IF NOT EXISTS "BusinessProfile" (
  ...
  "fundingDetails"     TEXT,
  "coFundingAvailable" TEXT,
  "matchFundingDetails" TEXT,
  "previousGrants"     TEXT,
  "directorNames"      TEXT,
  "directorProfiles"   TEXT,
  "teamMembers"        TEXT,
  "boardMembers"       TEXT,
  ...
  "geographicImpact"   TEXT,
  "diversityInclusionImpact" TEXT,
  "jobsCreated"        INTEGER,
  "revenueGrowthExpected" TEXT,
  "co2Reduction"       TEXT,
  "productivityImprovements" TEXT,
  "milestones"         TEXT,
  "deliverables"       TEXT,
  "partnerOrganisations" TEXT,
  "collaborationDetails" TEXT,
  "risksMitigation"    TEXT,
  "exitStrategy"       TEXT,
  "projectSustainabilityPlan" TEXT,
