...
const april = {
  grantName: "April grant",
  score: 84,
  addedAt: "2026-04-20T00:00:00.000Z",
  scoredAt: "2026-07-01T00:00:00.000Z",
};

const withinReach = [april, may, june].sort((a, b) =>
  sortEligibleMatchesForSection("within_reach", a, b),
);
assert.deepEqual(
...
const highFresh = {
  grantName: "Fresh high",
  score: 85,
  addedAt: "2026-06-01T00:00:00.000Z",
};
const highHigherScore = {
  grantName: "Older higher score",
  score: 91,
  addedAt: "2026-04-01T00:00:00.000Z",
};
const suggested = [highFresh, highHigherScore].sort((a, b) =>
  sortEligibleMatchesForSection("suggested", a, b),
);
assert.equal(
  suggested[0].grantName,
  "Older higher score",
  "Suggested should keep score as primary ordering",
);

// Exact post-filter counts and pagination are covered by test-criteria-portfolio.

const batchedList = readFileSync(
  "components/grants/batched-eligible-grants-list.tsx",
  "utf8",
);
assert.match(
  batchedList,
