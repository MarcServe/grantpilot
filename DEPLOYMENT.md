...
| `TWILIO_WHATSAPP_DIGEST_CONTENT_SID` | WhatsApp | Optional. Dedicated approved Content Template SID for `grant_scan_digest`. Placeholders: `{{1}}` profile name, `{{2}}` summary of strong matches, `{{3}}` My Matches URL. If absent, digests reuse `TWILIO_WHATSAPP_GRANT_MATCH_CONTENT_SID` so business-initiated WhatsApp avoids Twilio 63016. |
